...
describe("Test for array.lua", function()
  ...
  it("fill()", function()
    ...
    assert.same({ 9, 9, 9, 0 }, a:fill(0, -1))
    assert.same({ 9, 9, 1, 1 }, a:fill(1, -2, -1))
  end)
  ...
  it("lastIndexOf()", function()
    ...
    assert.same(1, a:lastIndexOf("Dodo", -2))
  ...
  it("slice()", function()
    ...
    assert.same({ "duck", "elephant" }, a:slice(-2))
  ...
  it("splice()", function()
    ...
    assert.same({ "Jan", "Feb", "March" }, a:splice(-2, 2))
  end)
  ...
  it("with()", function()
    ...
    assert.same({ 1, 2, 3, 4 }, a)
    assert.same({ 1, 2, 3, 5 }, a:with(-1, 5))
  end)
end)
